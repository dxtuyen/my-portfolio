...
export const tutorData: TutorData = {
  ...
  experience: [
    ...
    },
    {
      ...
      description:
        '<ul style="list-style-type: disc; padding-left: 1.25rem; display: flex; flex-direction: column; gap: 0.25rem;"><li>Trúng tuyển các đại học top như Đại học Bách khoa Hà Nội.</li><li>Đỗ vào các trường cấp 3 công lập và trường chuyên.</li><li>Từ mất gốc đến tự tin môn học.</li><li>Học sinh lười học tìm ra mục đích việc học và ham học.</li></ul>',
    },
  ],
  teachingStyle: [
    {
