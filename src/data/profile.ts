...
export const profile: Profile = {
  ...
  about:
    'Tôi là sinh viên ngành Mạng máy tính và Truyền thông dữ liệu tại Đại học Công nghệ (VNU-UET). Ở đó người ta thường nói về code và robot, và tôi cũng không ngoại lệ, nhưng có lẽ pha vào đó một chút lãng mạn hơn.😄✨',
  about2:
    'Ngoài việc học tập khoa học công nghệ, tôi dành thời gian tối ưu hóa không gian quản lý kiến thức cá nhân và trau dồi kỹ năng mềm để hoàn thiện bản thân mỗi ngày. Tôi thích tư duy logic kết hợp với thực tế, theo đuổi chủ nghĩa tối giản. Luôn tò mò và bị hấp dẫn bởi sự giao thoa giữa công nghệ và các lĩnh vực khoa học tự nhiên.',
  philosophy:
